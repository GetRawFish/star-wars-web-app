// tests/planetsView.spec.ts
import { test, expect, Page } from '@playwright/test'

test.describe('PlanetsView Component', () => {
  let page: Page
  ...
  test('should load and display planets cards', async () => {
    ...
    // Check if planets cards are displayed
  ...
  test('should handle sorting by name', async () => {
    ...
    const nameSortButton = page.locator('#planet-name-sort')
  ...
  test('should handle sorting by date', async () => {
    ...
    const dateSortButton = page.locator('#planet-date-sort')
  ...
  test('should handle error state', async () => {
    // Mock API failure
    await page.route('https://swapi.info/api/planets', (route) => route.abort())
